...
SUITESPARSE_VER=${SUITESPARSE_VER:-6.0.1}
...
SUNDIALS_VER=${SUNDIALS_VER:-6.4.1}
...
# There are installation problems with:
# https://github.com/gnu-octave/statistics/archive/refs/tags/release-1.5.0.tar.gz
