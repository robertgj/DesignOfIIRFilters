...
depends="test/directFIRhilbert_bandpass_slb_test.m \
test_common.m \
...
#
cat > test_hM1.ok << 'EOF'
hM1 = [   0.0057429515,   0.0446936390,  -0.0153998398,  -0.0693183724, ... 
         -0.0045099026,   0.1230534520,   0.0942725252,  -0.4963204809 ]';
EOF
