...
depends="test/schurOneMAPlattice_frm_slb_update_constraints_test.m \
test_common.m \
...
print_polynomial.m H2Asq.m H2T.m H2P.m \
...
Pl=[ -0.023457 -0.026450 -0.035893 ](rad./pi)
pu=[ 162 382 530 ]
f(pu)=[ 0.080500 0.190500 0.264500 ](fs=1)
Pu=[ 0.026335 0.032535 0.012580 ](rad./pi)
EOF
