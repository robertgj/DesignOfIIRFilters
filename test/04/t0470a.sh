...
#
cat > test_hM.ok << 'EOF'
hM = [  -0.0050228608,  -0.0056260821,   0.0001730616,   0.0120362938, ... 
         0.0192892646,   0.0084364539,  -0.0216174913,  -0.0494186881, ... 
        -0.0396876244,   0.0302234541,   0.1456662844,   0.2549999550, ... 
         0.2999253029 ]';
EOF
...
diff -Bb test_hM.ok xfr2tf_test_hM_coef.m
