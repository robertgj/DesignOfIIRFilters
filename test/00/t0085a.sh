...
Va1=5,Qa1=6,Ra1=2
a1 = [  -0.9516579991,  -0.8763813679,  -0.7286538332,  -0.4477857743, ... 
         0.5529552919, ...
         0.2521663198,   0.2747000321,   0.2973280878, ...
         2.3193264177,   0.4169651478,   0.9868726779 ]';
EOF
...
% All-pass single-vector representation
Vb1=5,Qb1=6,Rb1=2
b1 = [  -0.9831963220,  -0.9193221267,  -0.8146681283,  -0.6112098954, ... 
         0.5519631066, ...
         0.1876915416,   0.2557418847,   0.2940210435, ...
         0.1061142202,   2.5549335242,   0.9020007691 ]';
EOF
