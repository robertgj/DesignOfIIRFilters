...
Va1=3,Qa1=8,Ra1=2
a1 = [  -0.7078436825,   0.0130067093,   0.5839793792, ...
         0.1623267493,   0.2803750010,   0.3386954498,   0.8837032058, ...
         2.4157483901,   1.7261753932,   0.3904592458,   3.1415926322 ]';
EOF
...
% All-pass single-vector representation
Vb1=3,Qb1=8,Rb1=2
b1 = [  -0.9677815905,  -0.5336630008,   0.5888292577, ...
         0.2965265569,   0.3269842731,   0.3876654423,   0.8441871720, ...
         1.3634773372,   2.0712301139,   0.4087090921,   3.1415652728 ]';
EOF
