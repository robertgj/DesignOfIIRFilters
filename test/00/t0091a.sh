...
Va1=1,Qa1=10,Ra1=2
a1 = [   0.4600365683, ...
         0.4320977844,   0.4425168740,   0.4532963592,   0.4580932091, ... 
         0.4744266200, ...
         2.2496579557,   1.7328516995,   1.1602733659,   0.5818630466, ... 
         2.7858784960 ]';
EOF
...
Vb1=1,Qb1=10,Rb1=2
b1 = [  -0.8715534120, ...
         0.5208864673,   0.5241748745,   0.5313145008,   0.5482018046, ... 
         0.5900731374, ...
         0.2868919754,   0.8607988959,   1.4318957932,   1.9979298106, ... 
         2.5631873391 ]';
EOF
