...
Va1=1,Qa1=10,Ra1=2
a1 = [   0.4607319564, ...
         0.4326824421,   0.4420883842,   0.4530757492,   0.4585085823, ... 
         0.4751404464, ...
         2.2479932422,   1.7318497359,   1.1611364271,   0.5828625168, ... 
         2.7856951663 ]';
EOF
...
Vb1=1,Qb1=10,Rb1=2
b1 = [  -0.8715143926, ...
         0.5207403373,   0.5242193414,   0.5314964308,   0.5482567350, ... 
         0.5900516330, ...
         0.2866906247,   0.8604419330,   1.4318195818,   1.9980913656, ... 
         2.5631921751 ]';
EOF
