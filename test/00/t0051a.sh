...
#
cat > test.N0.ok << 'EOF'
N0 = [   0.0032220979,  -0.0048726780,   0.0077411139,  -0.0154771557, ... 
         0.0438701588,  -0.4031253928,   0.3995108392,   0.0055386853, ... 
        -0.0345541756 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test.N0.ok"; fail; fi

cat > test.D0.ok << 'EOF'
D0 = [   1.0000000000,  -0.1241853901,  -0.0064005678,  -0.0041311777, ... 
        -0.0027225314 ]';
EOF
