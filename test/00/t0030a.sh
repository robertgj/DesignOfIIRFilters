...
a = [  -0.0021092647,   0.0004069328,   0.0076883394,   0.0051931734, ... 
       -0.0115231075,  -0.0210543663,   0.0019486079,   0.0417050317, ... 
        0.0578424348,   0.0390044904,   0.0123776723 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed x.a output cat"; fail; fi
cat > test.d.ok << 'EOF'
d = [   1.0000000000,  -2.4277939763,   3.0446749920,  -2.3351332894, ... 
        1.1383562681,  -0.3371599420,   0.0468622434 ]';
EOF
