...
Va1=1,Qa1=10,Ra1=1
a1 = [  -0.8029214622, ...
         0.4215592501,   0.7265097581,   0.7932717123,   0.8005670810, ... 
         0.8359558022, ...
         0.2769745596,   0.3335008281,   1.7724812160,   1.3588378499, ... 
         2.7459140904 ]';
EOF
...
% All-pass single-vector representation
Vb1=2,Qb1=10,Rb1=1
b1 = [  -0.8127109384,   0.7218330936, ...
         0.7384130635,   0.7520477524,   0.7545863637,   0.7768656342, ... 
         0.8422069485, ...
         0.6506789317,   1.3716450370,   0.9502050533,   1.7786445895, ... 
         2.7447869585 ]';
EOF
