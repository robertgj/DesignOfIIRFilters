...
Va1=1,Qa1=10,Ra1=1
a1 = [  -0.7964158891, ...
         0.4095700620,   0.7263027076,   0.8027895849,   0.8044586300, ... 
         0.8232561496, ...
         0.2084534085,   0.3357210315,   1.3730348375,   1.6720156560, ... 
         2.7425806801 ]';
EOF
...
% All-pass single-vector representation
Vb1=2,Qb1=10,Rb1=1
b1 = [  -0.8074556603,   0.7202277713, ...
         0.7386020102,   0.7517807029,   0.7544520045,   0.7829163212, ... 
         0.8305504291, ...
         0.6520535218,   1.4041364418,   0.9518105736,   1.6622704473, ... 
         2.7406712146 ]';
EOF
