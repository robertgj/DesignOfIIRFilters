...
a1 = [  -0.8725346286, ...
         ...
         0.9370759613, ...
         0.4079147752,   0.3169851638,   1.2933025702,   1.9987960303, ... 
         2.7577077724 ]';
EOF
...
b1 = [  -0.8734715744,   0.6936496296, ...
         0.7013081979,   0.7096002960,   0.7192014919,   0.9162731465, ... 
         0.9374486726, ...
         0.6315610615,   1.2101188949,   0.9165394630,   1.9988786175, ... 
         2.7579923587 ]';
EOF
