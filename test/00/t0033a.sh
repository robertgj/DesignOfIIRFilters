...
depends="test/parallel_allpass_socp_mmse_test.m test_common.m \
...
Va1=1,Qa1=10,Ra1=1
a1 = [  -0.8725346286, ...
         0.5054873494,   0.6898092692,   0.7484363369,   0.9175385669, ... 
         0.9370759612, ...
...
b1 = [  -0.8734715744,   0.6936496296, ...
         0.7013081978,   0.7096002960,   0.7192014919,   0.9162731464, ... 
         0.9374486725, ...
