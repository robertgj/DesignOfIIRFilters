...
A1s20_1 = [  -0.4211736270,   0.5668175948,   0.5270040143,  -0.5461931018, ... 
              0.6550530930,  -0.2373180661,  -0.1084214338,   0.3962189225, ... 
             -0.2633216807,   0.1290400036 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_A1s20_1.ok"; fail; fi

cat > test_A1s00_1.ok << 'EOF'
A1s00_1 = [   0.9084068159,   0.8252132200,   0.8517229975,   0.8404082641, ... 
              0.7590176045,   0.9736149894,   0.9921875000,   0.9172621108, ... 
              0.9652192693,   0.9921875000 ]';
EOF
...
A2s20_1 = [  -0.7587537631,   0.6911203023,   0.5193006191,  -0.5950226421, ... 
              0.6777168704,  -0.1762382584,  -0.0940535856,   0.3878630497, ... 
             -0.2548103024,   0.1428570801 ]';
EOF
...
A2s00_1 = [   0.6520216724,   0.7230685714,   0.8565448384,   0.8038448364, ... 
              0.7388111211,   0.9865658921,   0.9918047788,   0.9202904315, ... 
