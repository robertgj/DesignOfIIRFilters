...
#
cat > test.N0.ok << 'EOF'
N0 = [   0.0019875059,  -0.0025184274,  -0.0020432962,   0.0041150520, ... 
         0.0021946462,  -0.0014832277,  -0.0082629097,  -0.0103198807, ... 
        -0.0019535563,   0.0056710920,   0.0086679019,   0.0043244903 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test.N0.ok"; fail; fi

cat > test.D0.ok << 'EOF'
D0 = [   1.0000000000,  -1.6644553416,   1.4112932957,   0.2832721097, ... 
        -1.9452822556,   2.0533103276,  -0.7216087821,  -0.6346434569, ... 
         1.0261914906,  -0.6689323063,   0.2357077908,  -0.0381562579 ]';
EOF
