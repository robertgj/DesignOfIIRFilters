...
prog=schurOneMPAlatticeDoublyPipelinedAntiAliasedT_test.m
depends="test/schurOneMPAlatticeDoublyPipelinedAntiAliasedT_test.m \
test_common.m \
...
tf2schurOneMlattice.m Abcd2tf.m qroots.oct schurOneMscale.m tf2pa.m H2T.m \
delayz.m phi2p.m tfp2g.m \
