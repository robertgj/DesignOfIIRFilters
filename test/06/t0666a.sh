...
prog=schurOneMAPlatticePipelinedT_test.m

depends="test/schurOneMAPlatticePipelinedT_test.m test_common.m \
schurOneMAPlatticePipelinedT.m schurOneMlatticePipelinedT.m \
