...
prog=schurOneMAPlatticePipelinedAsq_test.m

depends="test/schurOneMAPlatticePipelinedAsq_test.m test_common.m \
schurOneMAPlatticePipelinedAsq.m schurOneMlatticePipelinedAsq.m \
