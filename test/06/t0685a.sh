...
prog=schurOneMPAlatticeDoublyPipelinedAntiAliasedAsq_test.m
depends="test/schurOneMPAlatticeDoublyPipelinedAntiAliasedAsq_test.m \
test_common.m \
...
tf2schurOneMlattice.m Abcd2tf.m qroots.m schurOneMscale.m tf2pa.m H2Asq.m \
phi2p.m tfp2g.m \
