...
prog=schurOneMAPlatticePipelinedP_test.m

depends="test/schurOneMAPlatticePipelinedP_test.m test_common.m \
schurOneMAPlatticePipelinedP.m schurOneMlatticePipelinedP.m \
