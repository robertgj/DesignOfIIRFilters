...
#
cat > test.k2.ok << 'EOF'
k2 = [  -0.5471624990,   0.6820335176,  -0.4175565712,  -0.1781235862, ... 
         0.5405933547,  -0.5077775684,   0.2096515704,   0.1257004580, ... 
        -0.2046664244,   0.1091919652,  -0.0244564293 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test.k2.ok"; fail; fi

cat > test.c2.ok << 'EOF'
c2 = [   0.0668018222,  -0.1296378723,  -0.4899974900,  -0.1417542738, ... 
         0.0190937537,   0.0710348472,  -0.0069908265,  -0.0120241991, ... 
         0.0018993889,   0.0087070260,   0.0004217389,  -0.0031520246 ]';
EOF
