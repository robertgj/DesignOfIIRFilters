...
Da0 = [   1.0000000000,  -1.7457429477,   3.1040099856,  -3.5963416800, ... 
          3.2843453298,  -2.3816066661,   1.3013726707,  -0.4873507913, ... 
          0.1001218703 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_Da0_coef.m"; fail; fi

cat > test_Db0_coef.m << 'EOF'
Db0 = [   1.0000000000,  -0.9331463206,   1.3449258142,  -0.5758499154, ... 
         -0.3551780094,   0.9781749542,  -1.0700915404,   0.7523063024, ... 
         -0.3423686464,   0.0781181387 ]';
EOF
