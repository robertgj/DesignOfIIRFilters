...
prog=schurOneMPAlatticeDoublyPipelinedDelay_kyp_Dinh_lowpass_test.m
depends="test/schurOneMPAlatticeDoublyPipelinedDelay_kyp_Dinh_lowpass_test.m \
...
nstr="schurOneMPAlatticeDoublyPipelinedDelay_kyp_Dinh_lowpass_test"
