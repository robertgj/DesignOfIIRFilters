...
schurdecomp.oct schurexpand.oct qroots.oct complex_zhong_inverse.oct \
Abcd2tf.oct"
...
#
cat > test.k2.ok << 'EOF'
k2 = [  -0.7336038596,   0.7019394760,  -0.5583676780,   0.4009253461, ... 
         0.4221216301,  -0.6302761774,   0.7239432432,  -0.6418192559, ... 
         0.5523928035,  -0.3021091709,   0.1026027347 ]';
EOF
...
cat > test.c2.ok << 'EOF'
c2 = [   0.0319586072,  -0.2417735163,  -0.0439344793,   0.0461217367, ... 
         0.0733048890,   0.0318091754,  -0.0419342877,   0.0094030600, ... 
         0.0111934224,  -0.0057132820,  -0.0121834073,  -0.0006914717 ]';
EOF
