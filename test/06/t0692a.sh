...
#
cat > test.k2.ok << 'EOF'
k2 = [   0.3400793621,   0.5828924404,  -0.3959452374,   0.3444664184, ... 
        -0.2944953535,   0.2266824479,  -0.1618689561,   0.0953291218, ... 
        -0.0521129172,   0.0185615780,  -0.0075651094 ]';
EOF
...
cat > test.c2.ok << 'EOF'
c2 = [   0.1610836152,  -0.2349478706,  -0.6559047064,   0.0330540124, ... 
         0.0642195707,  -0.0479243080,   0.0152804212,   0.0006585637, ... 
        -0.0102477356,   0.0058970693,  -0.0036881407,  -0.0010506032 ]';
EOF
