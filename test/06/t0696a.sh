...
print_polynomial.m flt2SD.m bin2SDul.m SDadders.m qroots.oct x2nextra.m \
...
12-bit 3-signed-digit(Lim)&1.2223e-05 & 42 & 26 \\
12-bit 3-signed-digit(branch-and-bound)&4.4460e-06 & 42 & 26 \\
EOF
