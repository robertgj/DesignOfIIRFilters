...
prog=schurOneMPAlatticeDoublyPipelinedAntiAliasedP_test.m
depends="test/schurOneMPAlatticeDoublyPipelinedAntiAliasedP_test.m \
test_common.m \
...
tf2schurOneMlattice.m Abcd2tf.m qroots.oct schurOneMscale.m tf2pa.m H2P.m \
phi2p.m tfp2g.m \
