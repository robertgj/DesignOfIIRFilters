...
prog=schurOneMPAlatticeDoublyPipelinedAntiAliaseddAsqdw_test.m
depends="test/schurOneMPAlatticeDoublyPipelinedAntiAliaseddAsqdw_test.m \
test_common.m \
...
tf2schurOneMlattice.m schurOneMscale.m tf2pa.m H2dAsqdw.m H2Asq.m phi2p.m \
tfp2g.m \
