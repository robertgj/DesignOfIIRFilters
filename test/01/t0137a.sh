...
k_ex = [   0.0000000000,   0.5571042853,   0.0000000000,   0.3559179239, ... 
           0.0000000000,   0.2900410724,   0.0000000000,   0.4290800563, ... 
           0.0000000000,   0.3121050135,   0.0000000000,   0.3214880290, ... 
           0.0000000000,   0.2071142804,   0.0000000000,   0.1496364149, ... 
           0.0000000000,   0.0607622465,   0.0000000000,   0.0274736199 ];
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test.k_ex.ok"; fail; fi

cat > test.c_ex.ok << 'EOF'
c_ex = [   0.0398765633,  -0.0814064094,  -0.3965417407,  -0.3737012407, ... 
          -0.0052509742,   0.2964924717,   0.4534663315,   0.1803426587, ... 
          -0.0617053079,  -0.0954653921,  -0.0413269525,   0.0053215544, ... 
          -0.0240468323,  -0.0432505439,  -0.0228890704,   0.0203711206, ... 
           0.0189791573,   0.0009201384,  -0.0026519007,   0.0095632109, ... 
           0.0134647981 ];
EOF
