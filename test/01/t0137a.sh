...
k_ex = [   0.0000000000,   0.7501025674,   0.0000000000,   0.4910302302, ... 
           0.0000000000,   0.3611075452,   0.0000000000,   0.4051678466, ... 
           0.0000000000,   0.3162240650,   0.0000000000,   0.2543732816, ... 
           0.0000000000,   0.1603659276,   0.0000000000,   0.1010410957, ... 
           0.0000000000,   0.0402538663,   0.0000000000,   0.0147305592 ];
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test.k_ex.ok"; fail; fi

cat > test.c_ex.ok << 'EOF'
c_ex = [   0.0770738885,   0.0080789731,  -0.3108419371,  -0.6172342965, ... 
          -0.2583025893,   0.0992371118,   0.2248608004,   0.1951751857, ... 
           0.0563604455,  -0.0956099864,  -0.0516283850,  -0.0063039184, ... 
          -0.0155966247,  -0.0525854121,  -0.0388132715,   0.0013482405, ... 
           0.0219093759,   0.0141206180,   0.0022498450,   0.0055827634, ... 
           0.0119898572 ];
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test.c_ex.ok"; fail; fi

cat > test.k_rd.ok << 'EOF'
k_rd = [  0.00000,  0.75000,  0.00000,  0.50000, ... 
...
c_rd = [  0.06250,  0.00000, -0.31250, -0.62500, ... 
         -0.25000,  0.09375,  0.21875,  0.18750, ... 
          0.06250, -0.09375, -0.06250, -0.00000, ... 
         -0.00000, -0.06250, -0.03125,  0.00000, ... 
...
k_bf = [  0.00000,  0.75000,  0.00000,  0.53125, ... 
          0.00000,  0.37500,  0.00000,  0.40625, ... 
          0.00000,  0.31250,  0.00000,  0.25000, ... 
          0.00000,  0.15625,  0.00000,  0.09375, ... 
          0.00000,  0.03125,  0.00000,  0.00000 ];
...
c_bf = [  0.06250,  0.00000, -0.31250, -0.62500, ... 
         -0.25000,  0.09375,  0.21875,  0.18750, ... 
          0.06250, -0.09375, -0.06250, -0.00000, ... 
         -0.00000, -0.06250, -0.03125,  0.00000, ... 
...
k_sd = [  0.00000,  0.75000,  0.00000,  0.50000, ... 
          0.00000,  0.37500,  0.00000,  0.40625, ... 
          0.00000,  0.31250,  0.00000,  0.25000, ... 
          0.00000,  0.15625,  0.00000,  0.09375, ... 
          0.00000,  0.03125,  0.00000, -0.00000 ];
...
c_sd = [  0.06250, -0.00000, -0.31250, -0.62500, ... 
         -0.25000,  0.09375,  0.21875,  0.18750, ... 
          0.06250, -0.09375, -0.06250,  0.00000, ... 
          0.00000, -0.06250, -0.03125, -0.00000, ... 
          0.03125, -0.00000, -0.00000, -0.00000, ... 
...
k_bfsd = [  0.00000,  0.75000,  0.00000,  0.53125, ... 
            0.00000,  0.37500,  0.00000,  0.40625, ... 
            0.00000,  0.31250,  0.00000,  0.25000, ... 
            0.00000,  0.15625,  0.00000,  0.09375, ... 
            0.00000,  0.03125,  0.00000,  0.00000 ];
...
c_bfsd = [  0.06250,  0.00000, -0.31250, -0.62500, ... 
           -0.25000,  0.09375,  0.21875,  0.18750, ... 
            0.06250, -0.09375, -0.06250,  0.00000, ... 
            0.00000, -0.06250, -0.03125,  0.00000, ... 
            0.00000,  0.00000,  0.00000,  0.00000, ... 
...
k_bfsdl = [  0.00000,  0.84375,  0.00000,  0.56250, ... 
             0.00000,  0.37500,  0.00000,  0.43750, ... 
             0.00000,  0.31250,  0.00000,  0.25000, ... 
             0.00000,  0.12500,  0.00000,  0.09375, ... 
             0.00000,  0.00000,  0.00000,  0.00000 ];
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test.k_bfsdl.ok"; fail; fi

cat > test.c_bfsdl.ok << 'EOF'
c_bfsdl = [  0.06250,  0.00000, -0.31250, -0.62500, ... 
            -0.25000,  0.09375,  0.21875,  0.18750, ... 
             0.06250, -0.09375, -0.06250,  0.00000, ... 
             0.00000, -0.06250, -0.03125,  0.00000, ... 
             0.03125,  0.00000,  0.00000,  0.00000, ... 
...
k_bfsdi = [  0.00000,  0.75000,  0.00000,  0.50000, ... 
             0.00000,  0.31250,  0.00000,  0.40625, ... 
             0.00000,  0.31250,  0.00000,  0.25000, ... 
             0.00000,  0.15625,  0.00000,  0.09375, ... 
             0.00000,  0.03125,  0.00000,  0.00000 ];
EOF
...
c_bfsdi = [  0.06250,  0.00000, -0.25000, -0.50000, ... 
            -0.25000,  0.12500,  0.25000,  0.25000, ... 
             0.06250, -0.12500, -0.06250,  0.00000, ... 
             0.00000, -0.06250, -0.03125,  0.00000, ... 
             0.03125,  0.00000,  0.00000,  0.00000, ... 
             0.00000 ];
EOF
