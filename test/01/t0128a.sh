...
A1k_bf = [  -0.8125000000,   0.7187500000 ];
A2k_bf = [  -0.7500000000,   0.9375000000,  -0.6875000000 ];
A1k_sd = [  -0.7500000000,   0.7500000000 ];
A2k_sd = [  -0.7500000000,   0.9375000000,  -0.7500000000 ];
A1k_bfsd = [  -0.7500000000,   0.7500000000 ];
A2k_bfsd = [  -0.7500000000,   0.8750000000,  -0.7500000000 ];
EOF
