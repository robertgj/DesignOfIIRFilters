...
#
cat > test.k2.ok << 'EOF'
k2 = [  -0.6631557832,   0.6512527618,  -0.5324169598,   0.3544107217, ... 
        -0.1741586071,   0.0475082049,   0.0000000000,   0.0000000000, ... 
...
cat > test.p2.ok << 'EOF'
p2 = [   1.0207031043,   0.4593540166,   0.9995370761,   0.5521280463, ... 
         0.7997179524,   0.9535685191,   1.0000000000,   1.0000000000, ... 
         1.0000000000,   1.0000000000 ];
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test.p2.ok"; fail; fi
cat > test.c2.ok << 'EOF'
c2 = [   0.4475968891,   0.8865087735,   0.0987236681,  -0.1374394972, ... 
        -0.0510640796,   0.0176040715,   0.0222779937,   0.0003522551, ... 
        -0.0078348476,  -0.0034867196,  -0.0000537418 ];
EOF
