...
bitflip_bandpass_test_common.m flt2SD.m SDadders.m x2nextra.m qroots.m \
qzsolve.oct bin2SD.oct bitflip.oct bin2SPT.oct"
...
n_ex = [   0.0134647981,   0.0093004749,   0.0152707494,   0.0131542605, ... 
           0.0343778470,   0.0309994585,   0.0230693330,  -0.0039462666, ... 
          -0.0020928898,  -0.0077387414,  -0.0384148536,  -0.0917402034, ... 
          -0.0993293249,  -0.0079764257,   0.1126065399,   0.1704330531, ... 
           0.0912920932,  -0.0265169723,  -0.1061551593,  -0.0850334099, ... 
          -0.0397898160 ];
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test.n_ex.ok"; fail; fi

cat > test.d_ex.ok << 'EOF'
d_ex = [   1.0000000000,   0.0000000000,   1.3256636081,   0.0000000000, ... 
           1.5192420722,   0.0000000000,   1.6305449006,   0.0000000000, ... 
           1.6074037638,   0.0000000000,   1.2729263008,   0.0000000000, ... 
           0.9223931550,   0.0000000000,   0.5341167447,   0.0000000000, ... 
           0.2710986426,   0.0000000000,   0.0971371613,   0.0000000000, ... 
           0.0274736199 ];
EOF
