...
a1 = [  -0.4212475173,   1.0771982502,   0.3177671209,  -1.0446316318, ... 
         ...
         0.3761881149,  -0.9054554963,   0.8005915007 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_a1_coef.m"; fail; fi

cat > test_a1sqm_coef.m << 'EOF'
a1sqm = [  -0.8079712526,   0.7379074505,   0.1462308075,  -0.1919638121, ... 
            0.2801222728,   0.5463645093,   0.1500432816,   0.2645641463, ... 
            0.1733748860,  -1.0781165842,   0.8564450520 ]';
EOF
