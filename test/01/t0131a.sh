...
depends="test/simplex_schurNSPAlattice_lowpass_test.m test_common.m \
tf2schurNSlattice.m truncation_test_common.m schurNSPAlattice2tf.m \
print_polynomial.m schurNSPAlattice_cost.m flt2SD.m x2nextra.m tf2pa.m \
schurNSlattice2Abcd.oct spectralfactor.oct schurNSscale.oct bin2SD.oct \
