...
bitflip.cc:initial cost=1.2130013
bitflip.cc:cof(2)=0x2c:cost 1.213001>1.109735 for 0x2e(mask=0x41,l=0x2e,bit=6)
bitflip.cc:cof(2)=0x2e:cost 1.109735>1.082687 for 0x30(mask=0x41,l=0x30,bit=6)
bitflip.cc:cof(3)=0x16:cost 1.082687>1.016599 for 0x18(mask=0x41,l=0x18,bit=6)
bitflip.cc:cof(6)=0xd:cost 1.016599>0.998073 for 0x3(mask=0x41,l=0x2,bit=6)
bitflip.cc:cof(6)=0x3:cost 0.998073>0.982993 for 0x5(mask=0x41,l=0x4,bit=6)
bitflip.cc:cof(6)=0x5:cost 0.982993>0.977964 for 0x7(mask=0x41,l=0x6,bit=6)
bitflip.cc:cof(7)=0x2f:cost 0.977964>0.902108 for 0x31(mask=0x41,l=0x30,bit=6)
bitflip.cc:cof(7)=0x31:cost 0.902108>0.884848 for 0x33(mask=0x41,l=0x32,bit=6)
bitflip.cc:cof(6)=0x7:cost 0.884848>0.874956 for 0x9(mask=0x41,l=0x8,bit=6)
bitflip.cc:cof(17)=0x12:cost 0.874956>0.864994 for 0x11(mask=0x60,l=0x11,bit=5)
bitflip.cc:cof(19)=0x24:cost 0.864994>0.863401 for 0x23(mask=0x60,l=0x3,bit=5)
bitflip.cc:cof(20)=0x38:cost 0.863401>0.842098 for 0x39(mask=0x60,l=0x19,bit=5)
bitflip.cc:cof(6)=0x9:cost 0.842098>0.841959 for 0x8(mask=0x60,l=0x8,bit=5)
bitflip.cc:cof(7)=0x33:cost 0.841959>0.839432 for 0x34(mask=0x60,l=0x14,bit=5)
bitflip.cc:cof(18)=0x1e:cost 0.839432>0.825390 for 0x1d(mask=0x60,l=0x1d,bit=5)
bitflip.cc:cof(20)=0x39:cost 0.825390>0.818275 for 0x3a(mask=0x60,l=0x1a,bit=5)
bitflip.cc:cof(4)=0x9:cost 0.818275>0.803031 for 0x8(mask=0x60,l=0x8,bit=5)
bitflip.cc:cof(6)=0x8:cost 0.803031>0.802145 for 0x7(mask=0x60,l=0x7,bit=5)
bitflip.cc:cof(19)=0x23:cost 0.802145>0.798297 for 0x22(mask=0x60,l=0x2,bit=5)
bitflip.cc:cof(20)=0x3a:cost 0.798297>0.769045 for 0x3b(mask=0x60,l=0x1b,bit=5)
bitflip.cc:cof(3)=0x18:cost 0.769045>0.761848 for 0x17(mask=0x60,l=0x17,bit=5)
bitflip.cc:cof(6)=0x7:cost 0.761848>0.756069 for 0x8(mask=0x60,l=0x8,bit=5)
bitflip.cc:cof(6)=0x8:cost 0.756069>0.753573 for 0x9(mask=0x60,l=0x9,bit=5)
bitflip.cc:cof(7)=0x34:cost 0.753573>0.742345 for 0x35(mask=0x60,l=0x15,bit=5)
bitflip.cc:cof(6)=0x9:cost 0.742345>0.741465 for 0xa(mask=0x60,l=0xa,bit=5)
bitflip.cc:final cost=0.7414653,fiter=5760
bitflip_test:nbits=7,bitstart=6,msize=5,cost_bf= 0.74147,fiter=5760
