...
Va1=2,Qa1=6,Ra1=1
a1 = [  -0.9420344984,   0.4953003820, ...
         0.1838399403,   0.5231645226,   0.9514650731, ...
         2.9757383654,   0.8244948628,   1.5187331572 ]';
EOF
...
% All-pass single-vector representation
Vb1=2,Qb1=6,Rb1=1
b1 = [  -0.9568676300,   0.3443840789, ...
         0.4512914739,   0.5743762478,   0.6067626402, ...
         0.5087321050,   1.2354220420,   2.0206780055 ]';
EOF
