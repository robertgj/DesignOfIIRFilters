...
prog=socp_relaxation_schurOneMlattice_bandpass_hilbert_13_nbits_test.m

depends="test/socp_relaxation_schurOneMlattice_bandpass_hilbert_13_nbits_test.m \
...
nstr="socp_relaxation_schurOneMlattice_bandpass_hilbert_13_nbits_test"
