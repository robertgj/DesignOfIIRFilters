...
prog=socp_relaxation_schurOneMPAlattice_lowpass_differentiator_12_nbits_test.m
depends="\
test/socp_relaxation_schurOneMPAlattice_lowpass_differentiator_12_nbits_test.m \
...
nstr="socp_relaxation_schurOneMPAlattice_lowpass_differentiator_12_nbits_test"
