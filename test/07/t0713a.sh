...
prog=socp_relaxation_schurOneMPAlattice_bandpass_hilbert_10_nbits_test.m
depends="test/socp_relaxation_schurOneMPAlattice_bandpass_hilbert_10_nbits_test.m \
...
nstr="socp_relaxation_schurOneMPAlattice_bandpass_hilbert_10_nbits_test"
