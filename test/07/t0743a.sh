...
prog=branch_bound_schurOneMPAlattice_lowpass_differentiator_alternate_12_nbits_test.m
depends="\
test/branch_bound_schurOneMPAlattice_lowpass_differentiator_alternate_12_nbits_test.m \
...
nstr="branch_bound_schurOneMPAlattice_lowpass_differentiator_alternate_12_nbits_test"
...
if [ $? -ne 0 ]; then echo "Failed diff -Bb test_cost.tab"; fail; fi
