...
Da0 = [   1.0000000000,  -0.3039518435,   0.7205284693,   0.0389850505, ... 
         -0.4757493712,   0.5108445433,  -0.3730873323,   0.1816568019, ... 
         -0.0371629643 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_Da0_coef.m"; fail; fi

cat > test_Db0_coef.m << 'EOF'
Db0 = [   1.0000000000,  -0.6443571515,   0.6193269056,  -0.0540039969, ... 
         -0.5345925378,   0.7008148420,  -0.4499983941,   0.1441519526, ... 
         -0.0185283201 ]';
EOF
