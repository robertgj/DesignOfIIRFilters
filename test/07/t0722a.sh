...
k = [   0.0000000000,  -0.3709487431,   0.0000000000,   0.5993065725, ... 
        0.0000000000,  -0.3221511695,   0.0000000000,   0.1362601535 ];
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_k_coef.m"; fail; fi

cat > test_c_coef.m << 'EOF'
c = [  -0.0056775741,   0.1085979960,   0.1622368891,   0.1800508922, ... 
        0.2657466934,   0.1706187694,   0.0543610553,   0.0128905576, ... 
       -0.0048836576 ];
EOF
