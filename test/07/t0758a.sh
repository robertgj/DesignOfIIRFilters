...
prog=socp_relaxation_schurOneMPAlatticeDoublyPipelinedAntiAliased_lowpass_12_nbits_test.m
depends="test/socp_relaxation_schurOneMPAlatticeDoublyPipelinedAntiAliased_lowpass_12_nbits_test.m \
test_common.m \
...
nstr="socp_relaxation_schurOneMPAlatticeDoublyPipelinedAntiAliased_lowpass_12_nbits_test"
