...
A1k2 = [   0.2927022393,   0.9995071520,  -0.4286277205,   0.0468763689, ... 
           0.0251348797,   0.0180019716,  -0.0250340238,   0.0071950490 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test.A1k2.ok"; fail; fi

cat > test.A2k2.ok << 'EOF'
A2k2 = [  -0.2699972121,   0.4367818742,  -0.3113479250,   0.1578182391, ... 
          -0.0519409175,   0.0087975778,  -0.0003027317,   0.0009201701 ]';
EOF
