...
prog=tarczynski_parallel_allpass_bandpass_hilbert_R2_test.m
depends="test/tarczynski_parallel_allpass_bandpass_hilbert_R2_test.m \
...
nstr=tarczynski_parallel_allpass_bandpass_hilbert_R2_test
