...
A1k = [   0.7710144273,  -0.0879088133,  -0.2675565670,  -0.0636387433, ... 
         -0.0589758376,   0.2446870328,  -0.1439286834,  -0.0042030603, ... 
          0.1645507537,  -0.1594764070,   0.0542396985 ];
EOF
...
A1p = [   1.0938626268,   0.3933288433,   0.4295689803,   0.5651055114, ... 
          0.6022889552,   0.6389215510,   0.8201893947,   0.9481098344, ... 
          0.9521032070,   0.8064266164,   0.9471545660 ];
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_A1p_coef.m"; fail; fi

cat > test_A2k_coef.m << 'EOF'
A2k = [   0.3880316552,  -0.2734885518,   0.1864480567,   0.1636110294, ... 
         -0.0463367654,   0.0417246937,  -0.2011467967,   0.1798134988, ... 
          0.0053795182,  -0.1784400281,   0.1504516290,  -0.0552347164 ];
EOF
...
A2p = [   1.0560405372,   0.7012056116,   0.9283712325,   0.7687585398, ... 
          0.9067544992,   0.9497907635,   0.9902828842,   0.8075970422, ... 
          0.9686013978,   0.9738260976,   0.8131062547,   0.9462097695 ];
EOF
