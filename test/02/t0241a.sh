...
local_max.m print_polynomial.m x2nextra.m sqp_bfgs.m armijo_kim.m invSVD.m \
updateWbfgs.m H2Asq.m H2T.m H2P.m H2dAsqdw.m flt2SD.m bin2SDul.m SDadders.m \
schurOneMlatticeFilter.oct schurOneMlattice2H.oct schurOneMlattice2Abcd.oct \
schurdecomp.oct schurexpand.oct qroots.oct bin2SD.oct bin2SPT.oct Abcd2tf.oct \
