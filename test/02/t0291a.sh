...
D1 = [   1.0000000000,   0.7309833546,  -0.2731621082,  -0.3205248814, ... 
        -0.2368338586,  -0.0201303946,   0.0561600325,  -0.0644659333, ... 
         0.2463389320,   0.0748790429,  -0.1477063780,   0.0189328705 ];
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_D1_coef.m"; fail; fi

cat > test_D2_coef.m << 'EOF'
D2 = [   1.0000000000,   0.0743838590,  -0.4665818477,   0.2758208861, ... 
         0.1612365026,   0.1296340238,  -0.0723719458,  -0.2194905347, ... 
         0.2681122503,  -0.1008172434,  -0.1193099519,   0.1485283990, ... 
        -0.0751249985 ];
EOF
