...
Exact & 1.4442 \\ 
8-bit rounded & 1.6096 \\ 
8-bit rounded with bitflipping & 0.9733 \\ 
8-bit 2-signed-digit & 3.1501 \\ 
8-bit 2-signed-digit with bitflipping & 1.5605 \\ 
EOF
