...
Exact & 3.0761 \\ 
8-bit rounded & 3.4206 \\ 
8-bit rounded with bitflipping & 1.5491 \\ 
8-bit 2-signed-digit & 5.6018 \\ 
8-bit 2-signed-digit with bitflipping & 1.7725 \\ 
EOF
...
nstr="bitflip_schurNSlattice_bandpass_test"
