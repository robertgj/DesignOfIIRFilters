...
Exact & 0.8928 \\ 
8-bit rounded & 1.8514 \\ 
8-bit rounded with bitflipping & 1.2684 \\ 
8-bit 2-signed-digit & 3.3847 \\ 
8-bit 2-signed-digit with bitflipping & 1.5473 \\ 
EOF
