...
Exact & 0.8898 \\ 
8-bit rounded & 1.4304 \\ 
8-bit rounded with bitflipping & 1.1480 \\ 
8-bit 2-signed-digit & 3.4226 \\ 
8-bit 2-signed-digit with bitflipping & 1.4537 \\ 
EOF
