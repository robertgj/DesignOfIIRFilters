...
depends="bitflip_schurNSlattice_bandpass_test.m \
...
Exact & 0.8898 \\ 
8-bit rounded & 1.4271 \\ 
8-bit rounded with bitflipping & 1.1480 \\ 
8-bit 2-signed-digit & 3.4061 \\ 
8-bit 2-signed-digit with bitflipping & 1.3342 \\ 
EOF
...
diff -Bb test.cost.ok bitflip_schurNSlattice_bandpass_test_cost.tab
