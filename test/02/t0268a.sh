...
k2 = [  -0.5737905243,  -0.1357855912,  -0.0532737998,  -0.0211252813, ... 
        -0.0087692349 ]';
EOF
...
u2 = [  -0.0009053578,  -0.0025419542,  -0.0071000772,  -0.0128152315, ... 
        -0.0309445483,  -0.0343344301,  -0.0517632442,  -0.0570292758, ... 
         0.4398763013 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_u2_coef.m"; fail; fi

cat > test_v2_coef.m << 'EOF'
v2 = [   0.0065323449,   0.0043889399,   0.0072034087,   0.0021045171, ... 
        -0.0078722513,  -0.0311693646,  -0.0808562468,  -0.3143710223 ]';
EOF
