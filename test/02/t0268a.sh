...
r2 = [   1.0000000000,  -0.4873336779,  -0.1066812905,  -0.0420127524, ... 
        -0.0168502548,  -0.0087697088 ];
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_r2_coef.m"; fail; fi

cat > test_k2_coef.m << 'EOF'
k2 = [  -0.5737912484,  -0.1357861406,  -0.0532745521,  -0.0211256540, ... 
        -0.0087697088 ];
EOF
...
u2 = [  -0.0009005863,  -0.0025457761,  -0.0071130804,  -0.0128019219, ... 
...
v2 = [   0.0065311034,   0.0043827834,   0.0072166026,   0.0020996444, ... 
