...
2048*k_Lim_12_bits = [      0,   1344,      0,   1044, ... 
                            0,    736,      0,    896, ... 
                            0,    608,      0,    513, ... 
                            0,    320,      0,    192, ... 
                            0,     64,      0,     32 ]';
...
2048*c_Lim_12_bits = [    144,    -16,   -576,   -996, ... 
                         -384,    208,    784,    632, ... 
                           56,   -161,   -168,    -28, ... 
                          -16,    -68,    -48,      0, ... 
                           64,     32,      0,      0, ... 
...
2048*k_Ito_12_bits = [      0,   1376,      0,   1040, ... 
                            0,    736,      0,    864, ... 
                            0,    608,      0,    512, ... 
                            0,    304,      0,    208, ... 
                            0,     68,      0,     28 ]';
...
2048*c_Ito_12_bits = [    144,    -16,   -576,   -992, ... 
                         -352,    224,    784,    640, ... 
                           56,   -160,   -168,    -32, ... 
                          -16,    -64,    -48,      8, ... 
                           48,     32,      4,     -1, ... 
...
2048*k_Lim_12_bits = [      0,   1376,      0,   1044, ... 
                            0,    720,      0,    864, ... 
                            0,    616,      0,    513, ... 
                            0,    304,      0,    208, ... 
                            0,     68,      0,     28 ]';
...
2048*c_Lim_12_bits = [    152,    -12,   -576,   -997, ... 
                         -352,    210,    784,    634, ... 
                           54,   -161,   -168,    -29, ... 
                          -15,    -67,    -52,      8, ... 
                           48,     36,      4,     -1, ... 
...
2048*c_Ito_12_bits = [    152,    -12,   -576,   -992, ... 
                         -360,    208,    784,    640, ... 
                           54,   -160,   -168,    -32, ... 
                          -16,    -64,    -52,      8, ... 
                           48,     35,      5,     -1, ... 
