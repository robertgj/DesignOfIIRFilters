...
schurOneMlattice2tf.m schurOneMlatticeNoiseGain.m tf2schurOneMlattice.m \
schurOneMscale.m print_polynomial.m H2T.m H2P.m flt2SD.m x2nextra.m \
schurOneMR2lattice2Abcd.m KW.m SDadders.m \
