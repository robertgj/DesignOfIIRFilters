...
k2 = [   0.5536769980,  -0.1235201662,   0.0415471001,  -0.0137669351, ... 
         0.0017635900 ]';
EOF
...
u2 = [  -0.0004757683,   0.0023811509,  -0.0069610787,   0.0130295760, ... 
        -0.0309575330,   0.0346282180,  -0.0508321990,   0.0580895749, ... 
         0.4386444704 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_u2_coef.m"; fail; fi

cat > test_v2_coef.m << 'EOF'
v2 = [   0.0065898869,  -0.0044866750,   0.0066687185,  -0.0031543598, ... 
        -0.0070499152,   0.0306106717,  -0.0815764103,   0.3141737964 ]';
EOF
