...
k2 = [   0.5532412738,  -0.1240057801,   0.0419179212,  -0.0134482063, ... 
         0.0021226629 ]';
EOF
...
u2 = [  -0.0005007722,   0.0023497967,  -0.0069745552,   0.0130219801, ... 
        -0.0310071586,   0.0345787211,  -0.0508633427,   0.0580413143, ... 
         0.4385600589 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_u2_coef.m"; fail; fi

cat > test_v2_coef.m << 'EOF'
v2 = [   0.0066076598,  -0.0044664687,   0.0066943332,  -0.0030982757, ... 
        -0.0069797353,   0.0306382597,  -0.0815581409,   0.3142361701 ]';
EOF
