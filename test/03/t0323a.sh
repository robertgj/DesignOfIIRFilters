...
Va1=0,Qa1=10,Ra1=1
a1 = [   0.3602537388,   0.7050913756,   0.7824437199,   0.8163809674, ... 
         0.8293073824, ...
         3.0946801438,   0.8225885477,   0.7720857140,   0.5392935486, ... 
         1.5022991755 ]';
EOF
...
% All-pass single-vector representation
Vb1=0,Qb1=10,Rb1=1
b1 = [   0.3719067758,   0.7673429240,   0.7990886539,   0.8167946916, ... 
         0.8328703806, ...
         3.0339880467,   0.4187895845,   1.0167451391,   1.2195506529, ... 
         1.4600521210 ]';
EOF
