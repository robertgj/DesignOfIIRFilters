...
Va1=0,Qa1=10,Ra1=1
a1 = [   0.0205430626,   0.7608269153,   0.7900494556,   0.8138905009, ... 
         0.8566518994, ...
         2.9360916520,   0.3859638112,   1.0158924747,   1.2309186769, ... 
         1.4950567909 ]';
EOF
...
% All-pass single-vector representation
Vb1=0,Qb1=10,Rb1=1
b1 = [   0.0236124618,   0.6453220681,   0.7782441142,   0.8022406875, ... 
         0.8535532560, ...
         0.3813632727,   0.8434383913,   0.7712380730,   0.5290892236, ... 
         1.5232913656 ]';
EOF
