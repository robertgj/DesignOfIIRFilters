...
angle_min_z = [  -1.6867929611,  -0.9302552852,  -0.7972774476,   0.7972774476, ... 
                  0.9302552852,   1.6867929611 ]';
...
abs_min_z = [   0.6579607033,   0.6579607033,   0.7351792081,   0.7351792081, ... 
                ...
                1.0000000000,   1.0000000000 ]';
angle_min_z = [  -0.0425643574,   0.0425643574,  -0.3772095902,   0.3772095902, ... 
                 -1.5299986802,  -0.8996762351,  -0.7949454092,   0.7949454092, ... 
                  0.8996762351,   1.5299986802 ]';
...
abs_min_z = [   1.0000000000,   1.0000000000,   1.0000000000,   1.0000000000, ... 
                1.0000000000,   1.0000000000 ]';
angle_min_z = [  -1.5242081056,  -0.9016003747,  -0.7952021422,   0.7952021422, ... 
                  0.9016003747,   1.5242081056 ]';
...
angle_min_z = [  -0.2141462959,   0.2141462959,  -0.4278501559,   0.4278501559, ... 
...
abs_min_p = [   0.9731476547,   0.9731476547,   0.9116525569,   0.8369769650, ... 
                0.7810131340,   0.7583429095,   0.7462530629,   0.7410545292, ... 
                0.7425280066,   0.7425280066,   0.7410545292,   0.9116525569, ... 
                0.7462530629,   0.7583429095,   0.8369769650,   0.7810131340 ]';
...
2z:nmin=6,nall=5,max_dBap=0.000001,min_dBap=-0.000004,max_dBas= 50.00,min_P= -0.13,max_P=  0.02
norm(delta)/norm(ak) < ftol
Solution is feasible!
abs_min_z = [   1.0000000000,   1.0000000000,   1.0000000000,   1.0000000000, ... 
                1.0000000000,   1.0000000000,   1.0000000000 ]';
angle_min_z = [  -1.2377504562,  -0.8814739697,  -0.7940214544,   0.7940214544, ... 
                  0.8814739697,   1.2377504562,   3.1415926536 ]';
abs_min_p = [   0.9687724593,   0.8935117383,   0.9687724593,   0.8935117383, ... 
                0.7962313542,   0.7465522546,   0.7398460574,   0.7962313542, ... 
                0.7183302561,   0.7465522546,   0.7398460574 ]';
angle_min_p = [   0.6858732418,   0.6603136027,  -0.6858732418,  -0.6603136027, ... 
                 -0.5643782650,  -0.3694310565,  -0.1934719381,   0.5643782650, ... 
                  0.0000000000,   0.3694310565,   0.1934719381 ]';
1z:nmin=7,nall=4,max_dBap=0.000000,min_dBap=-0.000312,max_dBas= 50.00,min_P=  0.00,max_P=  0.11
abs_min_z = [   0.6401272668,   0.6401272668,   0.6694715024,   0.6694715024, ... 
                1.0000000000,   1.0000000000,   1.0000000000,   1.0000000000, ... 
                1.0000000000,   1.0000000000,   1.0000000000 ]';
angle_min_z = [  -0.3173648302,   0.3173648302,  -0.1937924613,   0.1937924613, ... 
                 -1.1395082493,  -0.8612573729,  -0.7923221698,   0.7923221698, ... 
                  0.8612573729,   1.1395082493,   3.1415926536 ]';
abs_min_p = [   0.7623944241,   0.7600782102,   0.7555234243,   0.7452036614, ... 
                0.7555234243,   0.7623944241,   0.7600782102,   0.7647251658, ... 
                0.7647251658,   0.8223665788,   0.8223665788,   0.9064286102, ... 
                0.9064286102,   0.9719562470,   0.9719562470 ]';
angle_min_p = [  -0.2394099903,  -0.3544572609,  -0.1298465082,  -0.0000000000, ... 
                  0.1298465082,   0.2394099903,   0.3544572609,  -0.4948107871, ... 
                  0.4948107871,  -0.6315773719,   0.6315773719,  -0.6894149772, ... 
...
abs_min_z = [   1.0000000000,   1.0000000000,   1.0000000000,   1.0000000000, ... 
                1.0000000000,   1.0000000000,   1.0000000000 ]';
angle_min_z = [  -0.7926146056,   0.7926146056,  -1.1448034302,  -0.8639740076, ... 
...
angle_min_p = [   0.6986862208,  -0.6986862208,   0.6842777423,  -0.6842777423, ... 
                 -0.6240568763,  -0.4696579261,  -0.2694147712,  -0.0897735678, ... 
                  0.0897735678,   0.6240568763,   0.2694147712,   0.4696579261 ]';
1z:nmin=7,nall=5,max_dBap=-0.000000,min_dBap=-0.000025,max_dBas= 50.00,min_P= -0.01,max_P=  0.10
abs_min_z = [   0.4702792856,   0.4702792856,   0.5890540974,   0.6045629758, ... 
                0.6045629758,   1.0000000000,   1.0000000000,   1.0000000000, ... 
                1.0000000000,   1.0000000000,   1.0000000000,   1.0000000000 ]';
angle_min_z = [  -0.5379051981,   0.5379051981,  -0.0000000000,  -0.2148086068, ... 
                  0.2148086068,  -1.0117341340,  -0.8391824187,  -0.7905151929, ... 
                  0.7905151929,   0.8391824187,   1.0117341340,   3.1415926536 ]';
abs_min_p = [   0.9757783576,   0.9197735029,   0.9757783576,   0.8435386329, ... 
                0.7624170847,   0.7157430804,   0.7047012112,   0.7067884085, ... 
                0.7067040328,   0.7066400991,   0.7067040328,   0.7067884085, ... 
                0.9197735029,   0.7047012112,   0.8435386329,   0.7157430804, ... 
                0.7624170847 ]';
