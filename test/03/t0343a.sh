...
A1k = [  -0.4134082897,   0.6137553649,   0.4782638011,  -0.5070468159, ... 
          0.7069628542,  -0.3017442451,  -0.0649390462,   0.3693197000, ... 
         -0.2551069581,   0.0898226165 ];
EOF
...
A1p = [   0.9748810473,   0.6280377816,   1.2837291127,   0.7626458373, ... 
          1.3334705784,   0.5525005829,   0.7543767794,   0.8050645921, ... 
          1.1862562718,   0.9138714538 ];
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_A1p_coef.m"; fail; fi

cat > test_A2k_coef.m << 'EOF'
A2k = [  -0.7696779513,   0.7233437079,   0.4465398111,  -0.5760186160, ... 
          0.7314429046,  -0.2540400916,  -0.0688779304,   0.3764937513, ... 
         -0.2341109017,   0.1053786835 ];
EOF
...
A2p = [   1.1863330162,   0.4279837253,   1.0681762807,   0.6607252870, ... 
          0.3426996420,   0.8701606155,   1.1282293406,   1.0530200609, ... 
          0.7087122311,   0.8996303086 ];
EOF
