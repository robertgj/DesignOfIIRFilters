...
A1k = [  -0.4126773091,   0.6121624855,   0.4807567954,  -0.5076822711, ... 
          0.7071033925,  -0.3012916971,  -0.0654447927,   0.3698390431, ... 
         -0.2553643522,   0.0901059383 ];
EOF
...
A1p = [   0.9785054967,   0.6309285425,   1.2863515463,   0.7617337821, ... 
          1.3330160938,   0.5521570870,   0.7535325692,   0.8045722006, ... 
          1.1862440498,   0.9136104587 ];
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_A1p_coef.m"; fail; fi

cat > test_A2k_coef.m << 'EOF'
A2k = [  -0.7696118573,   0.7220666701,   0.4494090024,  -0.5767379011, ... 
          0.7316206985,  -0.2535917735,  -0.0691300602,   0.3770400627, ... 
         -0.2342915624,   0.1058413900 ];
EOF
...
A2p = [   1.1952705794,   0.4312779772,   1.0735244673,   0.6616541230, ... 
          0.3428119560,   0.8707787760,   1.1284899437,   1.0529964960, ... 
          0.7082452936,   0.8992094471 ];
EOF
