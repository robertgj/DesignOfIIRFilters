...
A1k = [  -0.3939153326,   0.6791864167,   0.4869936857,  -0.5227238042, ... 
          0.6064097122,  -0.2245313023,  -0.1690034563,   0.4339350463, ... 
         -0.2820570054,   0.1648134004 ];
EOF
...
A1p = [   0.8371032984,   1.2694938522,   0.5548907943,   0.9447148166, ... 
          0.5289018005,   1.0685159747,   0.8503118073,   1.0085246059, ... 
          0.6336579569,   0.8467663277 ];
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_A1p_coef.m"; fail; fi

cat > test_A2k_coef.m << 'EOF'
A2k = [  -0.7513025795,   0.7499737529,   0.4817203757,  -0.5676365983, ... 
          0.6227597171,  -0.1388366090,  -0.1232165270,   0.4248774867, ... 
         -0.3098492108,   0.1516632902 ];
EOF
...
A2p = [   1.1730620807,   0.4420547313,   1.1694967239,   0.6916684254, ... 
          0.3632450595,   0.7533864316,   0.8663746262,   0.9805986467, ... 
          0.6229923467,   0.8582649328 ];
EOF
