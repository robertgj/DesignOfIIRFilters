...
Da0 = [   1.0000000000,  -1.1407481566,   0.8988308115,   0.6949247479, ... 
         -1.3934884362,   1.2277643695,  -0.0826221360,  -0.6255100680, ... 
          0.7512197591,  -0.3866689589,   0.1217695906 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_Da0_coef.m"; fail; fi
cat > test_Db0_coef.m << 'EOF'
Db0 = [   1.0000000000,  -1.7618798291,   1.1355013318,   0.8656471512, ... 
         -1.9626408512,   1.5176798205,  -0.0660722867,  -0.8553201039, ... 
          0.9372013822,  -0.4725589617,   0.1297887839 ]';
EOF
