...
Da0 = [   1.0000000000,  -1.3418437506,   0.9472712150,   0.8926921080, ... 
         -1.9565316043,   1.7227114413,  -0.3124124183,  -0.6218995940, ... 
          0.7601120493,  -0.3621396311,   0.0925640128 ]';
EOF
if [ $? -ne 0 ]; then echo "Failed output cat test_Da0_coef.m"; fail; fi

cat > test_Db0_coef.m << 'EOF'
Db0 = [   1.0000000000,  -1.9567138604,   1.2932044578,   1.1287958019, ... 
         -2.6899639195,   2.1579757173,  -0.3117688496,  -0.8685462806, ... 
          0.9361654225,  -0.4302842615,   0.0999264678 ]';
EOF
