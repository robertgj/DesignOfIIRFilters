...
prog=directFIRsymmetric_socp_mmsePW_test.m
depends="test/directFIRsymmetric_socp_mmsePW_test.m test_common.m \
...
diff -Bb test_hM1_coef.ok directFIRsymmetric_socp_mmsePW_test_hM1_coef.m
