...
SDadders.m H2Asq.m H2T.m H2P.m H2dAsqdw.m tf2schurOneMlattice.m \
schurOneMscale.m \
...
Exact & 0.001597 & & \\
12-bit 3-signed-digit(Ito)& 0.023677 & 60 & 40 \\
12-bit 3-signed-digit(SOCP B-and-B) & 0.001466 & 59 & 39 \\
EOF
