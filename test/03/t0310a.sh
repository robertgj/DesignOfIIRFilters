...
depends="test/directFIRhilbert_slb_exchange_constraints_test.m \
test_common.m \
...
Al=[ 0.000000 0.000000 0.000000 ](dB)
au=[ 101 ]
f(au)=[ 0.050000 ](fs=1)
Au=[ -0.050000 ](dB)
vS before exchange constraints:
al=[ 121 213 332 ]
f(al)=[ 0.060000 0.106000 0.165500 ](fs=1)
Al=[ 0.045385 0.016524 0.006742 ](dB)
