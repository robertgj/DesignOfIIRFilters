...
Exact & 0.001727 & -39.9 & & \\
13-bit 3-signed-digit & 0.157268 & -17.6 & 60 & 40 \\
13-bit 3-signed-digit(Ito) & 0.069628 & -30.8 & 60 & 40 \\
13-bit 3-signed-digit(SDP) & 0.015712 & -29.9 & 60 & 40 \\
13-bit 3-signed-digit(min) & 0.001859 & -35.8 & 60 & 40 \\
EOF
