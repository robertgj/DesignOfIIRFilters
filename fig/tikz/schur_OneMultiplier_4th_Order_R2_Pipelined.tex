% schur_OneMultiplier_4th_Order_R2_Pipelined.tex
...
\begin{tikzpicture}
	...
	\matrix (m1) [row sep=5mm, column sep=5mm]
	{
		...
		\node[coordinate]                   (m009) {};          &
		\node[dspadder]                     (m010) {};          &
		\node[dspnodefull, dsp/label=above] (m011) {$x_{3}$};    &
		\node[dspsquare]                    (m012) {$z^{-1}$};   &
		\node[dspadder]                     (m013) {};          &
		\node[coordinate]                   (m014) {};          &
		\node[coordinate]                   (m015) {};          &
		\node[coordinate]                   (m016) {};          &
	...
	%--------------------------------------------------------------------
		...
		\node[dspnodefull, dsp/label=above] (m309) {$x_{4}$};    &
		...
		\node[coordinate]                   (m409) {};           &
		\node[coordinate]                   (m410) {};           &
		\node[dspnodefull, dsp/label=above] (m411) {$x_{2}$};    &
		\node[dspsquare]                    (m412) {$z^{-1}$};   &
		\node[coordinate]                   (m413) {};           &
		\node[dspadder]                     (m414) {};           &
		\node[coordinate]                   (m415) {};           &
	...
	\begin{scope}[start chain]
		...
		\chainin (m012) [join=by dspconn];
		\chainin (m011) [join=by dspconn];	
