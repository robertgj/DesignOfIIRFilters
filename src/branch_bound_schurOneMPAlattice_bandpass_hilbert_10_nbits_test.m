...
if use_best_branch_and_bound_found
  if 0
    % Wap=5
    branches_min=1048;
    A1k_min = [     -196,      296,      276,     -252, ... 
                     392,     -148,      -32,      225, ... 
                    -140,       62 ]'/512;
    A2k_min = [     -400,      368,      261,     -280, ... 
                     400,     -133,      -30,      225, ... 
                    -131,       65 ]'/512;
  else
    branches_min=1575; Esq_min=0.00221513
    A1k_min = [     -200,      287,      271,     -256, ... 
                     392,     -152,      -33,      222, ... 
                    -138,       64 ]'/512;
    A2k_min = [     -392,      352,      263,     -284, ... 
                     400,     -134,      -32,      224, ... 
                    -132,       67 ]'/512;
  endif
...
pass-band(nbits=%d,ndigits=%d) : ftpl=%g,ftpu=%g",nbits,ndigits,ftpl,ftpu);
  ...
  % Save results
  save branch_bound_schurOneMPAlattice_bandpass_hilbert_10_nbits_test.mat ...
