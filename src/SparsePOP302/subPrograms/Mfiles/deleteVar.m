...
while count == 1
	...
	if debugSW == 1
		fprintf('count = %d\n', count);
		writePOP(debugSW, NewobjPoly, NewineqPolySys, Newlbd, Newubd);
		disp(NewfixedVar);
	end
	%%
...
[CompSup, binarySup, SquareOneSup, ConstraintInfo] = separateSpecialMonomial(NewineqPolySys,param);
