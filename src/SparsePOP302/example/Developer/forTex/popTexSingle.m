function popTexSingle(param, probNumbers, problemList, compResult, Esize, fpname)
...
%%%-->
fprintf(fpid, '%sbegin{tabular}{|c|c|cccc|ccc|}\n', backS);
fprintf(fpid, '%shline\n', backS);
fprintf(fpid, 'Problem%s $r$%sSDPobj%s POPobj%s absE%s ',aand,aand,aand, aand,aand);
...
for j=1:Esize
    ...
    fprintf(fpid, '%s  %d %s ', aand,  ro, aand);
