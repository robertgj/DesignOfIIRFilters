function [xVect,yVect] = dConvClToCoLOsol(x,y,CoLOno,seqLOPs); 
...
%     qDim2 = sum(seqLOPs{CoLOno}.J.q);
%     rowPointer = rowPointer+qDim2; 
end
...
if isfield(seqLOPs{CoLOno-1}.K,'s') && ~isempty(seqLOPs{CoLOno-1}.K.s)
    ...
    for kk=1:noOfSDPcones
        ...
        for p=1:seqLOPs{CoLOno}.clique{kk}.NoC
            ...
            pMat = reshape(uVect(rowPointer+1:rowPointer+sDimE*sDimE,:),sDimE,sDimE);
