...
if use_best_branch_and_bound_found
  % Terminated after 27180 branches
  branches_min=27180;
  ...
  %{
  % Terminated after 1.5 days and 17847 branches:
  branches_min=17847;
  k_min = [     -445,      506,     -390,      415, ... 
                -266,      439,     -331,      401, ... 
                -284,      284,     -112,       69, ... 
                  23,        7,       11,       10, ... 
                   6,        1,        2,        3 ]'/512;
  c_min = [     -100,      -31,     -511,     -256, ... 
                  38,      395,      510,     -312, ... 
                 -64,       -8,        1,       -9, ... 
                  -2,       12,       14,        0, ... 
                   0,        4,        3,       -1, ... 
                  -4 ]'/512;
  % Previously (octave-10.3.0) :
  branches_min=45855;
  ...
  do
    ...
    try  
      ...
      schurOneMlattice_slb(@schurOneMlattice_socp_mmse, ...
                           kc_b(Rk),epsilon0,p0,kc_b(Rc)/cscale, ...
