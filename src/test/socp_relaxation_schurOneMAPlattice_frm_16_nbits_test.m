% socp_relaxation_schurOneMAPlattice_frm_16_nbits_test.m
...
strf="socp_relaxation_schurOneMAPlattice_frm_16_nbits_test";
...
% Options
socp_relaxation_schurOneMAPlattice_frm_16_nbits_test_allocsd_Lim=false
socp_relaxation_schurOneMAPlattice_frm_16_nbits_test_allocsd_Ito=true
...
if socp_relaxation_schurOneMAPlattice_frm_16_nbits_test_allocsd_Lim
  ndigits_alloc=schurOneMAPlattice_frm_allocsd_Lim ...
                  (nbits,ndigits,k0,epsilon0,p0,u0,v0,Mmodel,Dmodel, ...
                   wa,Asqd,ones(size(Wa)), ...
                   wt,Td,ones(size(Wt)), ...
                   wp,Pd,ones(size(Wp)));
elseif socp_relaxation_schurOneMAPlattice_frm_16_nbits_test_allocsd_Ito
...
% Save results
save socp_relaxation_schurOneMAPlattice_frm_16_nbits_test.mat ...
