% directFIRsymmetricSqErr_bandpass_test.m
...
M=20;
h=remez(2*M,2*[0,fasl,fapl,fapu,fasu,0.5],[0,0,1,1,0,0],[Wasl,Wap,Wasu]);
hM=h(1:(M+1));

% Initialise
tol=1e-8
directFIRsymmetricSqErr_bandpass(0,hM,fasl,fapl,fapu,fasu,Wasl,Wasu);
...
Esq_A=trapz(wa,arrayfun(@directFIRsymmetricSqErr_bandpass,wa))
if abs(Esq-Esq_A)>eps
  error("abs(Esq-Esq_A)>eps");
endif

% Octave quadrature variants. quadcc, quadgk and quadl fail badly.
[Esq_Q, IER_Q,NFUN_Q,ERR_Q]=quad  (@directFIRsymmetricSqErr_bandpass,0,pi,tol)
[Esq_V, NFUN_V]            =quadv (@directFIRsymmetricSqErr_bandpass,0,pi,tol)
[Esq_CC,ERR_CC,NR_CC]      =quadcc(@directFIRsymmetricSqErr_bandpass,0,pi,tol)
[Esq_GK,ERR_GK]            =quadgk(@directFIRsymmetricSqErr_bandpass,0,pi,tol)
[Esq_L, NFUN_L]            =quadl (@directFIRsymmetricSqErr_bandpass,0,pi,2*tol)

% Done
diary off
movefile directFIRsymmetricSqErr_bandpass_test.diary.tmp ...
         directFIRsymmetricSqErr_bandpass_test.diary;
