...
strf="socp_relaxation_schurOneMlattice_hilbert_R2_10_nbits_test";
...
% Options
socp_relaxation_schurOneMlattice_hilbert_R2_10_nbits_test_allocsd_Lim=true
socp_relaxation_schurOneMlattice_hilbert_R2_10_nbits_test_allocsd_Ito=false
...
%
% Coefficients found by schurOneMlattice_socp_slb_hilbert_R2_test.m
%
schurOneMlattice_socp_slb_hilbert_R2_test_N2_coef;
schurOneMlattice_socp_slb_hilbert_R2_test_D2_coef;
...
if socp_relaxation_schurOneMlattice_hilbert_R2_10_nbits_test_allocsd_Lim
  ndigits_alloc=schurOneMlattice_allocsd_Lim(nbits,ndigits,k0,epsilon0,p0,c0, ...
                                             wa,Asqd,ones(size(wa)), ...
                                             wt,Td,ones(size(wt)), ...
                                             wp,Pd,ones(size(wp)));
elseif socp_relaxation_schurOneMlattice_hilbert_R2_10_nbits_test_allocsd_Ito
...
legend("boxoff");
legend("left");
strt=sprintf("Hilbert filter: R=2,ftt=%g,dBar=%g,tp=%g,pr=%g,Wap=%g,Wpp=%g", ...
