...
strf="schurOneMlattice_socp_slb_bandpass_hilbert_R2_test";
...
% Initial filter 
tarczynski_bandpass_hilbert_R2_test_N0_coef;
tarczynski_bandpass_hilbert_R2_test_D0_coef;
D0R=[1;kron(D0(2:end),[0;1])];
...
Asq1=schurOneMlatticeAsq(wa,k2,epsilon2,p2,c2);
P1=schurOneMlatticeP(wp,k2,epsilon2,p2,c2);
T1=schurOneMlatticeT(wt,k2,epsilon2,p2,c2);
