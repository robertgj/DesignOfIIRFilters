...
for difference=[false,true]
  if difference
    ...
    Td=td*ones(nplot-npass,1);
    Wt=Wtp*ones(nplot-npass,1);
    wp=wplot((npass+1):end);
    Pd=-(2*wplot((npass+1):end))-pi;
    Wp=Wpp*ones(nplot-npass,1);
  else
    H=(Hap1+Hap2)/2;
    wa=wplot;
  ...
  Esq=schurOneMPAlatticeDoublyPipelinedEsq ...
        (A1k,A2k,difference,wa/2,Asqd,Wa,wt/2,Td,Wt,wp/2,Pd,Wp);
  ...
  for l=1:NA1k
    EsqkPdel2=schurOneMPAlatticeDoublyPipelinedEsq ...
                (A1k+delk,A2k,difference,wa/2,Asqd,Wa,wt/2,Td,Wt,wp/2,Pd,Wp);
  ...
  for l=1:NA2k
    EsqkPdel2=schurOneMPAlatticeDoublyPipelinedEsq ...
                (A1k,A2k+delk,difference,wa/2,Asqd,Wa,wt/2,Td,Wt,wp/2,Pd,Wp);
    EsqkMdel2=schurOneMPAlatticeDoublyPipelinedEsq ...
                (A1k,A2k-delk,difference,wa/2,Asqd,Wa,wt/2,Td,Wt,wp/2,Pd,Wp);
    delk=circshift(delk,1);
    diff_Esqk(l)=(EsqkPdel2-EsqkMdel2)/del;
  ...
  for l=1:NA1k
    [~,gradEsqkPdel2]=schurOneMPAlatticeDoublyPipelinedEsq ...
                        (A1k+delk,A2k,difference, ...
                         wa/2,Asqd,Wa,wt/2,Td,Wt,wp/2,Pd,Wp);
