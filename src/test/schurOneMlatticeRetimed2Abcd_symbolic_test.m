% schurOneMlatticeRetimed2Abcd_symbolic_test.m
% Copyright (C) 2022 Robert G. Jenssen
%
% Create symbolic descriptions of retimed Schur one-multiplier all-pass filters
%
...
("rM%d=[[0, -k%d,0,0,-(1+E%d*k%d)*k%d,(1+E%d*k%d)*(1+E%d*k%d)];...\n\
  ...
  [rA,rB,rC,rD,rCap,rDap] = ...
    schurOneMlatticeRetimed2Abcd(k,epsilon,ones(size(k)),c);
