% socp_relaxation_schurOneMPAlattice_bandpass_hilbert_10_nbits_test.m
% Copyright (C) 2025 Robert G. Jenssen

% SOCP relaxation optimisation of a Schur parallel one-multiplier allpass
% lattice bandpass filter with 10-bit signed-digit coefficients having
% an average of 3 signed-digits

test_common;

strf="socp_relaxation_schurOneMPAlattice_bandpass_hilbert_10_nbits_test"
