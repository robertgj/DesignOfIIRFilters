...
if use_best_branch_and_bound_found
  ...
  elseif ...
    ...
    if 1
      % Esq_min=0.00137687
      A1k_min = [     -864,     1660,     -464,       60, ... 
                      1496,    -1032,      800,      600, ... 
                      -648,      432 ]'/2048;
      A2k_min = [    -1624,     1760,     -576,      -68, ... 
                      1520,     -976,      800,      624, ... 
                      -624,      448 ]'/2048;
    else
      branches_min=211;
      % Previous solution. Esq_min=0.00166863 
    ...
    if 1
      % Esq_min=0.00167977
      branches_min=571;
      A1k_min = [     -897,     1664,     -416,       34, ... 
                      1520,    -1000,      800,      648, ... 
                      -568,      492 ]'/2048;
      A2k_min = [    -1664,     1760,     -574,      -39, ... 
                      1534,     -944,      832,      641, ... 
                      -528,      517 ]'/2048;
    else
      % Previous solution. Esq_min=0.00302588
      branches_min=209;
      A1k_min = [     -964,     1728,     -760,      368, ... 
                      1264,     -928,      528,      368, ... 
                      -352,      162 ]'/2048;
      A2k_min = [    -1600,     1808,     -895,      316, ... 
                      1296,     -864,      536,      376, ... 
                      -316,      176 ]'/2048;
    endif
  endif
