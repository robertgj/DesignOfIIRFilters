...
delete("tarczynski_bandpass_R2_test.diary");
delete("tarczynski_bandpass_R2_test.diary.tmp");
diary tarczynski_bandpass_R2_test.diary.tmp
...
print_polynomial(N,"N","tarczynski_bandpass_R2_test_N_coef.m");
print_polynomial(D,"D");
print_polynomial(D,"D","tarczynski_bandpass_R2_test_D_coef.m");
[x,U,V,M,Q]=tf2x(N,D);
print_pole_zero(x,U,V,M,Q,R,"x");
print_pole_zero(x,U,V,M,Q,R,"x","tarczynski_bandpass_R2_test_x_coef.m");

% Save the result
save tarczynski_bandpass_R2_test.mat U V M Q R x0 fapl fapu fasl fasu ...
     Wap Watl Watu Wasl Wasu td dBas n nN nD R ND N D DR

% Done
toc
diary off
movefile tarczynski_bandpass_R2_test.diary.tmp tarczynski_bandpass_R2_test.diary;
