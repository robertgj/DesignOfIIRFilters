...
strf="directFIRsymmetric_slb_exchange_constraints_test";
...
vR=directFIRsymmetric_slb_update_constraints(A0,Adu,Adl,ctol);

% Optimise
na=[1 nasl napl napu nasu length(wa)];
[hM1,socp_iter,func_iter,feasible]= ...
  directFIRsymmetric_mmsePW(vR,hM0,hM_active,na,wa,Ad,Adu,Adl,Wa, ...
...
vS=directFIRsymmetric_slb_update_constraints(A1,Adu,Adl,ctol);
...
[vR,vS,exchanged]= ...
  directFIRsymmetric_slb_exchange_constraints(vS,vR,A1,Adu,Adl,ctol);
