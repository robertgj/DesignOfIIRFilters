...
strf="branch_bound_schurOneMPAlattice_lowpass_differentiator_12_nbits_test";
...
branch_bound_schurOneMPAlattice_lowpass_differentiator_allocsd_Lim=true
branch_bound_schurOneMPAlattice_lowpass_differentiator_allocsd_Ito=false
...
% Initial filter 
schurOneMPAlattice_socp_slb_lowpass_differentiator_test_A1k2_coef;
schurOneMPAlattice_socp_slb_lowpass_differentiator_test_A2k2_coef;
...
rho=1023/1024;
fap=0.2;fas=0.4;
Arp=0;Ars=0;Wap=10;Wat=0.1;Was=1;
...
if branch_bound_schurOneMPAlattice_lowpass_differentiator_allocsd_Lim
  if 0
    ndigits_alloc = ...
  ...
  strItoLim="Lim";
elseif
  branch_bound_schurOneMPAlattice_lowpass_differentiator_allocsd_Ito
  ndigits_alloc = ...
...
subplot(311);
plot(wa*0.5/pi,[A_k0 A_k0_sd Adl Adu]);
ylabel("Amplitude");
axis([0 0.5 0 1]);
grid("on");
...
branch_bound_schurOneMPAlattice_lowpass_differentiator_allocsd_Lim));
fprintf(fid,sprintf("%s_allocsd_Lim=%d\n", strf,...
branch_bound_schurOneMPAlattice_lowpass_differentiator_allocsd_Ito));
