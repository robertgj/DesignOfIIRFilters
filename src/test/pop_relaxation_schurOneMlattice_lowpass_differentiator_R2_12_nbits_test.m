...
fap=0.2;fas=0.4;
Arp=0.002;Art=0.002;Ars=0.01;Wap=1;Wat=0.0001;Was=0.1;
fpp=fap;pp=1.5;ppr=0.001;Wpp=1;
ftp=fap;tp=nN-1;tpr=0.016;Wtp=0.1;
fdp=0.1;cpr=0.016;cn=1;Wdp=0.1;
...
Dd=dAsqddw(Rdp);
Wd=Wdp*ones(size(wd));
Cd=(Dd-(Asqd(Rdp).*cot(w(Rdp)/2)))./Azsq(Rdp);
...
vS=schurOneMlattice_slb_update_constraints ...
     (Csq_kc_min,Asqdu./Azsq,Asqdl./Azsq,Wa, ...
      Tc_kc_min,Tdu-Tz,Tdl-Tz,Wt, ...
      Pc_kc_min,Pdu-Pz,Pdl-Pz,Wp, ...
      dCsqdw_kc_min,Cdu,Cdl,Wd, ...
      ctol);
schurOneMlattice_slb_show_constraints ...
  (vS,wa,Csq_kc_min,wt,Tc_kc_min,wp,Pc_kc_min,wd,dCsqdw_kc_min);

printf("These constraints on the diff. filter response are not met:\n");
vS=schurOneMlattice_slb_update_constraints ...
     (Asq_kc_min,Asqdu,Asqdl,Wa, ...
      T_kc_min,Tdu,Tdl,Wt, ...
      P_kc_min,Pdu,Pdl,Wp, ...
      dAsqdw_kc_min,Ddu,Ddl,Wd, ...
      ctol);
schurOneMlattice_slb_show_constraints ...
...
legend("exact","s-d(Lim)","s-d(POP-relax)");
...
eval(sprintf(["save %s.mat ftol ctol nbits nscale ndigits ndigits_alloc n ", ...
 ...
 "ftp tp tpr Wtp fpp pp ppr Wpp fdp cpr cn Wdp ", ...
