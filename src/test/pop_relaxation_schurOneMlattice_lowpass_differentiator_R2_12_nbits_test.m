...
fap=0.2;fas=0.4;
Arp=0.002;Art=0.002;Ars=0.0103;Wap=1;Wat=0.0001;Was=0.1;
fpp=fap;pp=1.5;ppr=0.002;Wpp=1;
ftp=fap;tp=nN-1;tpr=0.03;Wtp=0.1;
...
vS=schurOneMlattice_slb_update_constraints ...
     (Csq_kc_min,Asqdu./Azm1sq,Asqdl./Azm1sq,Wa, ...
      Tc_kc_min,Tdu-Tzm1,Tdl-Tzm1,Wt, ...
      Pc_kc_min,Pdu-Pzm1,Pdl-Pzm1,Wp, ...
