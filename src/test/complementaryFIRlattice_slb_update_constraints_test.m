...
plot(fa,10*log10([Asq0,Asq1,Asqdu,Asqdl]), ...
     ...
     fa(vS1.al),10*log10(Asq1(vS1.al)),"s", ...
     fa(vS1.au),10*log10(Asq1(vS1.au)),"d");
title(strM);
axis([0,0.5,-35,0.25]);
ylabel("Amplitude");
xlabel("Frequency")
...
% Done
diary off
movefile complementaryFIRlattice_slb_update_constraints_test.diary.tmp ...
         complementaryFIRlattice_slb_update_constraints_test.diary;
