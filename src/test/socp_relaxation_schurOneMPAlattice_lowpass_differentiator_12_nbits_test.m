% socp_relaxation_schurOneMPAlattice_lowpass_differentiator_12_nbits_test.m
% Copyright (C) 2025 Robert G. Jenssen

test_common;

strf="socp_relaxation_schurOneMPAlattice_lowpass_differentiator_12_nbits_test";
...
difference=true;
fap=0.2;fas=0.4;
Arp=0.006;Ars=0.004;Wap=10;Wat=0.1;Was=1;
fpp=fap;pp=0.5;ppr=0.001;Wpp=0.5;
ftp=fap;tp=ceil((NA1+NA2)/2);tpr=0.04;Wtp=1;
fdp=0.1;cpr=0.008;cn=4;Wdp=1;
...
[k_min_digits,k_min_adders]=SDadders(k_min(k0_active),nbits);
...
% Set linestyle and copy line colour
hac=get(ha,"color");
hls={"-","--","-."};
for c=1:3
