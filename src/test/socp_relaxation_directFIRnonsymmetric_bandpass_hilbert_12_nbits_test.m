...
% SOCP-relaxation search for the 12-bit 3-signed-digit coefficients of a
% direct-form non-symmetric Hilbert bandpass filter

test_common;

strf="socp_relaxation_directFIRnonsymmetric_bandpass_hilbert_12_nbits_test";
...
dBap=1;dBas=30;Wasl=1;Watl=0.01;Wap=1;Watu=0.01;Wasu=2;
pp=3.5;ppr=0.004;fppl=0.12;fppu=0.18;Wpp=2;
tp=16;tpr=0.04;ftpl=0.12;ftpu=0.18;Wtp=1;
...
ndigits_alloc=directFIRnonsymmetric_allocsd_Lim(nbits,ndigits, ...
...
xlabel("Frequency");
ylabel("Amplitude(dB)");
legend("Exact","s-d","s-d(Lim)","s-d(SOCP)");
...
% Save results
eval(sprintf(["save %s.mat h h_sd h_Lim_sd h_min ftol ctol nbits ndigits ", ...
