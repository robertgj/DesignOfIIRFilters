...
delete("socp_relaxation_directFIRhilbert_10_nbits_test.diary");
delete("socp_relaxation_directFIRhilbert_10_nbits_test.diary.tmp");
diary socp_relaxation_directFIRhilbert_10_nbits_test.diary.tmp

tic;

strf="socp_relaxation_directFIRhilbert_10_nbits_test";
maxiter=1000
verbose=false;
tol=1e-5;
ctol=tol;
...
% Save results
save socp_relaxation_directFIRhilbert_10_nbits_test.mat ...
     fapl fapu dBap Wap Was tol ctol ...
     nbits nscale ndigits ndigits_alloc npoints ...
     hM0 hM0_sd hM0_Ito_sd hM_min
       
% Done
toc;
diary off
movefile socp_relaxation_directFIRhilbert_10_nbits_test.diary.tmp ...
         socp_relaxation_directFIRhilbert_10_nbits_test.diary;
