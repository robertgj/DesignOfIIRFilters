% selesnickFIRantisymmetric_flat_differentiator_test.m
...
for K=0:3,
  N=K+(2*L)+2;
  [~,C(:,K+1)]=selesnickFIRantisymmetric_flat_differentiator(N,K);
...
for k=1:nheven,
  ...
  heven{k}.K=K;
  heven{k}.N=N;
  [heven{k}.h,heven{k}.c]=selesnickFIRantisymmetric_flat_differentiator(N,K);
...
strt=sprintf("Selesnick maximally-flat FIR differentiator : \
...
for k=1:nhodd,
  ...
  hodd{k}.K=K;
  hodd{k}.N=N;
  [hodd{k}.h,hodd{k}.c]=selesnickFIRantisymmetric_flat_differentiator(N,K);
...
save selesnickFIRantisymmetric_flat_differentiator_test.mat C hodd heven

%
% Done
%
diary off
movefile selesnickFIRantisymmetric_flat_differentiator_test.diary.tmp ...
         selesnickFIRantisymmetric_flat_differentiator_test.diary;
