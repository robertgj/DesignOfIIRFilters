...
unlink("surmaaho_parallel_allpass_lowpass_test.diary");
unlink("surmaaho_parallel_allpass_lowpass_test.diary.tmp");
...
fid=fopen("surmaaho_parallel_allpass_lowpass_test.spec","wt");
