...
unlink("schurOneMAPlattice_frm_halfbandT_test.diary");
unlink("schurOneMAPlattice_frm_halfbandT_test.diary.tmp");
...
if max(abs(T(1:nap)-Tp(1:nap))) > 1284*eps;
  error("max(abs(T(1:%d)-Tp(1:%d))) > 1284*eps (%d*eps)", ...
