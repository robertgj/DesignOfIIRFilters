...
unlink("sdp_relaxation_schurOneMlattice_bandpass_10_nbits_test.diary");
unlink("sdp_relaxation_schurOneMlattice_bandpass_10_nbits_test.diary.tmp");
...
ftpl=0.09,ftpu=0.21,tp=16,tpr=0.16,Wtp=5
