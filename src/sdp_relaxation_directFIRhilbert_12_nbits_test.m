...
unlink("sdp_relaxation_directFIRhilbert_12_nbits_test.diary");
unlink("sdp_relaxation_directFIRhilbert_12_nbits_test.diary.tmp");
...
if 1
  ...
  Adl_slb=[zeros(napl-1,1); ...
       ...
       zeros(npoints-napu,1)];
  [hM1,slb_iter,socp_iter,func_iter,feasible]= ...
  directFIRhilbert_slb(@directFIRhilbert_sdp_mmsePW, ...
