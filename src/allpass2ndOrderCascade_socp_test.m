...
unlink("allpass2ndOrderCascade_socp_test.diary");
unlink("allpass2ndOrderCascade_socp_test.diary.tmp");
...
ab0 = [  -0.5478752668,   0.4915792316,   0.5985607909,   0.2484099431, ... 
          0.7101442419,  -0.0605195903,  -0.2133743207,   0.1753695535, ... 
         -0.3837027275,  -0.5079941963,   0.2248212367,   0.8969805674, ... 
          0.1281716646,  -0.2809554584,  -0.2066809555,  -0.8829960274, ... 
          0.6331297080,   0.2399910222,   0.7217787976,  -1.2526002924, ... 
          0.5453460036,   0.5092305885,   0.6164199165 ]';
a0=ab0(1:ma);
b0=ab0((ma+1):end);
