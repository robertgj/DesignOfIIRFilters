...
unlink("schurOneMlattice_sqp_slb_lowpass_test.diary");
unlink("schurOneMlattice_sqp_slb_lowpass_test.diary.tmp");
...
strF=sprintf("schurOneMlattice_sqp_slb_lowpass_test_%%s_%%s");
...
% Save the results
%
fid=fopen("schurOneMlattice_sqp_slb_lowpass_test.spec","wt");
...
print_polynomial(k2,"k2","schurOneMlattice_sqp_slb_lowpass_test_k2_coef.m");
print_polynomial(epsilon2,"epsilon2");
print_polynomial(epsilon2,"epsilon2",...
                 "schurOneMlattice_sqp_slb_lowpass_test_epsilon2_coef.m","%2d");
print_polynomial(p2,"p2");
print_polynomial(p2,"p2","schurOneMlattice_sqp_slb_lowpass_test_p2_coef.m");
print_polynomial(c2,"c2");
print_polynomial(c2,"c2","schurOneMlattice_sqp_slb_lowpass_test_c2_coef.m");
print_polynomial(n2,"n2");
print_polynomial(n2,"n2","schurOneMlattice_sqp_slb_lowpass_test_n2_coef.m");
print_polynomial(d2,"d2");
print_polynomial(d2,"d2","schurOneMlattice_sqp_slb_lowpass_test_d2_coef.m");
save schurOneMlattice_sqp_slb_lowpass_test.mat x0 n0 d0 k0 epsilon0 p0 c0 ...
     ...
     Was_pcls dmax rho tol k1 epsilon1 p1 c1 k2 epsilon2 p2 c2 n2 d2
