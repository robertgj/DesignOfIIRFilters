...
delete("iir_sqp_slb_bandpass_test.diary");
delete("iir_sqp_slb_bandpass_test.diary.tmp");
...
showResponsePassBands(ftpl,ftpu,-3,3,x0,U,V,M,Q,R,strI);
...
close
showResponsePassBands(ftpl,ftpu,-2*dBap,dBap,x1,U,V,M,Q,R,strM);
...
% Done 
save iir_sqp_slb_bandpass_test.mat U V M Q R tol ctol fapl fapu dBap Wap ...
