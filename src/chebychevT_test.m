...
unlink("chebychevT_test.diary");
unlink("chebychevT_test.diary.tmp");
diary chebychevT_test.diary.tmp

strf="chebychevT_test";

%
% Check Chebychev Type 1 polynomials
%
for n=1:12
  [Tn,Tnm1]=chebychevT(n);
  print_polynomial(Tn,sprintf("T%d",n),"%6d");
  print_polynomial(Tnm1,sprintf("T%d",n-1),"%6d");
endfor

%
% Check Chebychev Type 1 identities in Section VI of "Zolotarev
...
% Done
diary off
movefile chebychevT_test.diary.tmp chebychevT_test.diary;
