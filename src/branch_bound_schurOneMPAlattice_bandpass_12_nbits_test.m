...
if use_best_branch_and_bound_found
  if branch_bound_schurOneMPAlattice_bandpass_12_nbits_test_allocsd_Lim
    ...
    A2k_min = [    -1514,     1544,      832,    -1054, ... 
                    1320,     -512,       62,      640, ... 
                    -464,      252 ]'/2048;
    branches_min=257; % 727 seconds
  else
    % Ito
    A1k_min = [  -824,     1424,      894,    -1032, ... 
                 1352,     -804,      160,      592, ... 
                 -480,      295 ]'/2048;
    A2k_min = [ -1528,     1532,      896,    -1124, ... 
                 1376,     -672,      224,      584, ... 
                 -512,      288   ]'/2048;
    branches_min=294; % 5493 seconds
  endif
