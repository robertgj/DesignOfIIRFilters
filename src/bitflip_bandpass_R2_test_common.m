% bitflip_bandpass_R2_test_common.m
% Copyright (C) 2017-2025 Robert G. Jenssen

% PCLS IIR band pass filter from iir_sqp_slb_bandpass_R2_test.m
iir_sqp_slb_bandpass_R2_test_D1_coef;
iir_sqp_slb_bandpass_R2_test_N1_coef;
d0 = D1;
n0 = N1;
