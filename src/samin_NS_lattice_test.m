...
unlink("samin_NS_lattice_test.diary");
unlink("samin_NS_lattice_test.diary.tmp");
diary samin_NS_lattice_test.diary.tmp
...
legend("left");
grid("on");
print("samin_NS_lattice_response","-dpdflatex");
close
...
legend("left");
grid("on");
print("samin_NS_lattice_passband_response","-dpdflatex");
close
...
save samin_NS_lattice_test.mat ...
...
% Done
diary off
movefile samin_NS_lattice_test.diary.tmp samin_NS_lattice_test.diary;
