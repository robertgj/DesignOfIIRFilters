...
unlink("schurOneMAPlattice_frm_hilbert_socp_mmse_test.diary");
unlink("schurOneMAPlattice_frm_hilbert_socp_mmse_test.diary.tmp");
diary schurOneMAPlattice_frm_hilbert_socp_mmse_test.diary.tmp
...
save schurOneMAPlattice_frm_hilbert_socp_mmse_test.mat ...
     ...
     fap fas Wap ftp fts tp Wtp fpp fps pp Wpp 

% Done
toc;
diary off
movefile schurOneMAPlattice_frm_hilbert_socp_mmse_test.diary.tmp ...
       schurOneMAPlattice_frm_hilbert_socp_mmse_test.diary;
