...
unlink("sdp_relaxation_schurOneMlattice_bandpass_12_nbits_test.diary");
unlink("sdp_relaxation_schurOneMlattice_bandpass_12_nbits_test.diary.tmp");
...
fasl=0.05,fasu=0.25,dBas=36,Wasl=1e6,Wasu=1e6
ftpl=0.09,ftpu=0.21,tp=16,tpr=tp/80,Wtp=5
...
schurOneMlattice_sdp_mmse([],kc0_sd_x(Rk),epsilon0,p0,kc0_sd_x(Rc), ...
...
while 1
  ...
  [k_sd_sdp,c_sd_sdp,socp_iter,func_iter,feasible] = ...
    schurOneMlattice_sdp_mmse([],kc_sd_x(Rk),epsilon0,p0,kc_sd_x(Rc), ...
