...
unlink("simplex_OneMPA_lattice_test.diary");
unlink("simplex_OneMPA_lattice_test.diary.tmp");
diary simplex_OneMPA_lattice_test.diary.tmp
...
legend("left");
grid("on");
print("simplex_OneMPA_lattice_response","-dpdflatex");
close
...
legend("left");
grid("on");
print("simplex_OneMPA_lattice_passband_response","-dpdflatex");
close
...
save simplex_OneMPA_lattice_test.mat ...
     A1k_rd A2k_rd A1k_sx A2k_sx A1k_sd A2k_sd A1k_sxsd A2k_sxsd

  % Done
diary off
movefile simplex_OneMPA_lattice_test.diary.tmp simplex_OneMPA_lattice_test.diary;
