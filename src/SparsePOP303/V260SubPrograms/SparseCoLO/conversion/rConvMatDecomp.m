%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [LOP,clique,convMat] = rConvMatDecomp(A,sPatternVect,b,c,K,J)

% The r-space conversion method using matrix decompositon
% 2009/01/10
% Masakazu Kojima
% 
% Input LOP problem 
...
if isfield(J,'s') && ~isempty(J.s)
    [LOP,clique,convMat] = dConvBasisRep(-A',sPatternVect,-c,-b,J,K);
    LOP.A = -LOP.A';
    c = -LOP.b;
    LOP.b = -LOP.c;
    LOP.c = c;
