...
% Common strings
strd=sprintf("parallel_allpass_socp_slb_flat_delay_%%s");
...
fid=fopen("parallel_allpass_socp_slb_flat_delay_test.spec","wt");
...
toc;
diary off
movefile parallel_allpass_socp_slb_flat_delay_test.diary.tmp parallel_allpass_socp_slb_flat_delay_test.diary;
