...
% Options
socp_relaxation_schurOneMPAlattice_lowpass_12_nbits_test_allocsd_Lim=false
socp_relaxation_schurOneMPAlattice_lowpass_12_nbits_test_allocsd_Ito=true
...
A1k_sd=k_sd(R1);
A2k_sd=k_sd(R2);
printf("nscale*A1k_sd_=[ ");printf("%g ",nscale*A1k_sd');printf("]';\n");
print_polynomial(nscale*A1k_sd,sprintf("%d*A1k_sd",nscale), ...
                 strcat(strF,"_A1k_sd_coef.m"),"%6d");
printf("nscale*A2k_sd_=[ ");printf("%g ",nscale*A2k_sd');printf("]';\n");
print_polynomial(nscale*A2k_sd,sprintf("%d*A2k_sd",nscale), ...
                 strcat(strF,"_A2k_sd_coef.m"),"%6d");
...
Esq0_sd=schurOneMPAlatticeEsq ...
          (k_sd(R1),A1epsilon,A1p,k_sd(R2),A2epsilon,A2p, ...
           wa,Asqd,Wa,wt,Td,Wt,wp,Pd,Wp);
  ...
  try
    ...
    schurOneMPAlattice_slb ...
      (@schurOneMPAlattice_socp_mmse, ...
       kopt_b(R1),A1epsilon,A1p,kopt_b(R2),A2epsilon,A2p, ...
...
Esq_min=schurOneMPAlatticeEsq ...
          (A1k_min,A1epsilon,A1p_ones,A2k_min,A2epsilon,A2p_ones, ...
           wa,Asqd,Wa,wt,Td,Wt,wp,Pd,Wp);
printf("\nSolution:\nEsq_min=%g\n",Esq_min);
...
Asq=schurOneMPAlatticeAsq ...
      (wa,A1k_min,A1epsilon,A1p_ones,A2k_min,A2epsilon,A2p_ones);
vAl=local_max(Asqdl-Asq);
vAu=local_max(Asq-Asqdu);
wAsqS=unique([wa(vAl);wa(vAu);wa([1,end])]);
AsqS=schurOneMPAlatticeAsq ...
       (wAsqS,A1k_min,A1epsilon,A1p_ones,A2k_min,A2epsilon,A2p_ones);
...
T=schurOneMPAlatticeT ...
    (wt,A1k_min,A1epsilon,A1p_ones,A2k_min,A2epsilon,A2p_ones);
vTl=local_max(Tdl-T);
vTu=local_max(T-Tdu);
wTS=sort(unique([wt(vTl);wt(vTu);wt([1,end])]));
TS=schurOneMPAlatticeT ...
     (wTS,A1k_min,A1epsilon,A1p_ones,A2k_min,A2epsilon,A2p_ones);
...
Asq_k=schurOneMPAlatticeAsq(wa,A1k,A1epsilon,A1p,A2k,A2epsilon,A2p);
Asq_k_sd=schurOneMPAlatticeAsq ...
           (wa,A1k_sd,A1epsilon,A1p_ones,A2k_sd,A2epsilon,A2p_ones);
Asq_kmin=schurOneMPAlatticeAsq ...
               (wa,A1k_min,A1epsilon,A1p_ones,A2k_min,A2epsilon,A2p_ones);
T_k=schurOneMPAlatticeT(wt,A1k,A1epsilon,A1p,A2k,A2epsilon,A2p);
T_k_sd=schurOneMPAlatticeT ...
         (wt,A1k_sd,A1epsilon,A1p_ones,A2k_sd,A2epsilon,A2p_ones);
...
legend("exact","3-s-d Ito and SOCP");
legend("location","northeast");
legend("Boxoff");
legend("left");
grid("on");
