...
delete("complementaryFIRlattice_test.diary");
delete("complementaryFIRlattice_test.diary.tmp");
diary complementaryFIRlattice_test.diary.tmp


strf="complementaryFIRlattice_test";
...
% Done
diary off
movefile complementaryFIRlattice_test.diary.tmp ...
         complementaryFIRlattice_test.diary;
