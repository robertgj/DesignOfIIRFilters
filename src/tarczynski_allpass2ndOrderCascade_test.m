...
unlink("tarczynski_allpass2ndOrderCascade_test.diary");
unlink("tarczynski_allpass2ndOrderCascade_test.diary.tmp");
...
grid("on");
if flat_delay
  s=sprintf("Parallel all-pass 2nd order cascade : ma=%d,mb=%d,fap=%g,fas=%g",
            ma,mb,fap,fas);
else
...
fid=fopen("tarczynski_allpass2ndOrderCascade_test.spec","wt");
