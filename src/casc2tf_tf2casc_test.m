...
% a=[]
printf("casc2tf_tf2casc_test.m : a=[]\n");
p=casc2tf([])
if p~=1
  error("p~=1");
endif
...
% p=1
printf("casc2tf_tf2casc_test.m : p=1\n");
p=1
[a,k]=tf2casc(p)
if ~isempty(a)
  error("~isempty(a)");
...
printf("casc2tf_tf2casc_test.m : even n, real poles\n");
...
% Odd n
printf("casc2tf_tf2casc_test.m : odd n\n");
...
printf("casc2tf_tf2casc_test.m : from frm2ndOrderCascade_socp.m\n");
