...
unlink("schurOneMPAlattice_socp_slb_lowpass_to_multiband_test.diary");
unlink("schurOneMPAlattice_socp_slb_lowpass_to_multiband_test.diary.tmp");
...
[A1k0,A1epsilon0,A1p0,A1c0]=tf2schurOneMlattice(A1,fliplr(A1));
[A2k0,A2epsilon0,A2p0,A2c0]=tf2schurOneMlattice(A2,fliplr(A2));
...
[Aap1,Bap1,~,~,Cap1,Dap1]= ...
  schurOneMlattice2Abcd(A1k0,A1epsilon0,A1p0,zeros(size(A1c0)));
