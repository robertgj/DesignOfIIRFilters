...
unlink("deczky3a_socp_test.diary");
unlink("deczky3a_socp_test.diary.tmp");
diary deczky3a_socp_test.diary.tmp
...
strd=sprintf("deczky3a_socp_mmse_%%s");
...
strd=sprintf("deczky3a_socp_pcls_%%s");
...
% Save results
fid=fopen("deczky3a_socp_test.spec","wt");
...
print_pole_zero(d2,U,V,M,Q,R,"d2","deczky3a_socp_test_d2_coef.m");
print_polynomial(N2,"N2","deczky3a_socp_test_N2_coef.m");
print_polynomial(D2,"D2","deczky3a_socp_test_D2_coef.m");
if verbose
...
save deczky3a_socp_test.mat U V M Q R ...
     n tol fap dBap Wap fas dBas Was ftp tp tpr Wtp x1 d2 N2 D2

% Done
toc;
diary off
movefile deczky3a_socp_test.diary.tmp deczky3a_socp_test.diary;
