% mcclellanFIRsymmetric_flat_differentiator_fail_test.m
% Copyright (C) 2020 Robert G. Jenssen
%
% Failed implementation of a maximally-flat FIR differentiator filter. The
...
M=(N-L-1)/2;
L2m1=(L/2)-1;
strt=sprintf("Selesnick-Burrus flat differentiator FIR : N=%d,L=%d,$f_{s}$=%g",
             N,L,fs);
F=((1:nplot)'/nplot)/2;
...
%
diary off
movefile mcclellanFIRsymmetric_flat_differentiator_fail_test.diary.tmp ...
         mcclellanFIRsymmetric_flat_differentiator_fail_test.diary;
