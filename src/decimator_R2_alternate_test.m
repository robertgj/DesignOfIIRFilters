...
unlink("decimator_R2_alternate_test.diary");
unlink("decimator_R2_alternate_test.diary.tmp");
...
close
showResponsePassBands(0,max(fap,ftp),-0.4,0.2,x1,U,V,M,Q,R,strM1);
...
close
showResponsePassBands(0,max(fap,ftp),-0.4,0.2,d1,U,V,M,Q,R,strP1);
